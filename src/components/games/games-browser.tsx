...
export function GamesBrowser({
  ...
  return (
    <div className="community-browser container mx-auto px-4 py-5 sm:py-7">
      <div className="mb-4 flex items-center justify-between gap-3"><div><h1 className="text-2xl font-semibold text-white sm:text-3xl">Explore games</h1><p className="mt-1 hidden text-sm text-text-secondary sm:block">Find something fun. Leave with an idea.</p></div><Link href="/quick-play" className="community-button">Quick play</Link></div>

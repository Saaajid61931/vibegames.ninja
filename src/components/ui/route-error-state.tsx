  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center px-4">
      <div className="max-w-md text-center">
        <AlertTriangle className="mx-auto mb-6 h-14 w-14 text-[#ff0040]" />
        <h1 className="font-arcade text-2xl text-white">{title}</h1>
        <p className="mt-3 font-arcade text-sm text-[#8b93a6]">{description}</p>
